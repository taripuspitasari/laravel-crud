        ...
        <form action="/dashboard/posts/{{ $post->slug }}" method="post" enctype="multipart/form-data">
            ...
            <div class="flex gap-2 flex-col">
                ...
                <div>
                    ...
                    @if($post->image)
                    <img src="{{ asset('storage/' . $post->image) }}" width="150" class="img-preview mb-2 block"> 
                    @else
                    <img width="150" class="img-preview mb-2"> 
                    @endif
