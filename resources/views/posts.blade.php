    <x-layout>
        ...
        {{ $posts->links() }}
            ...
            <div class="py-4 p4x-4 mx-auto max-w-screen-xl lg:py-8 lg:px-0">
        ...
        @forelse ($posts as $post)
                    ...
                    @empty
                    <div class="p-6 text-gray-400 text-cente dark:bg-gray-800 dark:border-gray-700">
                        <p class="font-semibold text-2xl">Article not found! -___-</p>
                        <a class="text-blue-600 hover:underline" href="/posts">&laquo; Back to all posts</a>
                    </div>                        
        @endforelse
            </div>  
        </div>
